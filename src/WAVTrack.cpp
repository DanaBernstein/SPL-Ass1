...
double WAVTrack::get_quality_score() const {
    ...
    if(sample_rate >= 44100) base_score = base_score + 10.0;
    if(sample_rate >= 96000) base_score = base_score + 5.0;
    if(bit_depth >= 16) base_score = base_score + 10.0;
    if(bit_depth >= 24) base_score = base_score + 5.0;
